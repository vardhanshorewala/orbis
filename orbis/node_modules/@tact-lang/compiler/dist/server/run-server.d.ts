...
export type Message = MessageText | MessagePath | MessageLocatedId | MessageExpected | MessageSource;
/**
 ...
 */
export declare const runServer: <T>(compile: (log: Logger<Message, never>) => T) => LogEntry[] | (T extends Promise<any> ? Promise<LogEntry[]> : LogEntry[]);
