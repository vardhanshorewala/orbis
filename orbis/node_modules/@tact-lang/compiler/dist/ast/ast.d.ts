...
export type Expression = OpBinary | OpUnary | Conditional | MethodCall | FieldAccess | StaticCall | StructInstance | Id | InitOf | CodeOf | MapLiteral | SetLiteral | Literal;
export type Literal = Number | Boolean | Null | String | Address | Cell | Slice | MapValue | StructValue;
