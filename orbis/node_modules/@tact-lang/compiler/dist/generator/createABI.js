        ...
        if (f.isGetter) {
            getters.push({
                ...
                arguments: f.params.map((v) => ({
                    ...
                    type: (0, resolveABITypeRef_1.createABITypeRefFromTypeRef)(ctx, v.type, v.loc, undefined),
                })),
                returnType: f.returns.kind !== "void"
                    ? (0, resolveABITypeRef_1.createABITypeRefFromTypeRef)(ctx, f.returns, f.ast.loc, undefined)
                    : null,
            });
        }
    }
