...
function ensureVariableDoesNotExist(ctx, sctx, name) {
    if (name.kind !== "id") {
        return;
    }
            ...
            case "statement_let":
                {
                    ...
                    if (s.type !== undefined) {
                        ...
                        if (expressionType.kind === "null") {
                            (0, errors_1.throwCompilationError)(`Cannot infer type for ${(0, errors_1.idTextErr)(name)}`, s.loc);
                        }
                        if (expressionType.kind === "void") {
                            (0, errors_1.throwCompilationError)(`The inferred type of variable ${(0, errors_1.idTextErr)(name)} is "void", which is not allowed`, s.loc);
                        }
            ...
            case "statement_try":
                {
                    ...
                    ensureVariableDoesNotExist(ctx, initialSctx, s.catchBlock.catchName);
