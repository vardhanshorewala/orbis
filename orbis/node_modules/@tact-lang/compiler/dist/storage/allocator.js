        ...
        case "builder":
            {
                switch (src.format) {
                    ...
                    case "remainder": {
                        if (src.optional) {
                            (0, errors_1.throwInternalCompilerError)(`"as remaining" cell cannot be optional`);
                        }
...
function getAllocationOperationFromField(src, structLoader) {
    ...
    switch (src.kind) {
        case "simple": {
            if (src.type === "int") {
                ...
                if (src.format !== null && src.format !== undefined) {
                    (0, errors_1.throwInternalCompilerError)(`Unsupported int format: ${src.format}`);
                }
                return {
                    kind: "int",
                    bits: 257,
            ...
            if (src.type === "uint") {
                if (typeof src.format === "number") {
                    if (src.format < 1 || src.format > 256) {
                        (0, errors_1.throwInternalCompilerError)(`Unsupported uint format: ${src.format}`);
                    }
                    return {
                        kind: "uint",
                        bits: src.format,
            ...
            if (src.type === "bool") {
                if (src.format !== null && src.format !== undefined) {
                    (0, errors_1.throwInternalCompilerError)(`Unsupported bool format: ${src.format}`);
                }
                return {
                    kind: "boolean",
                    optional: src.optional ?? false,
            ...
            if (src.type === "cell") {
                if (src.format === "remainder") {
                    ...
                    (0, errors_1.throwInternalCompilerError)(`Unsupported cell format: ${src.format}`);
                }
                return {
                    kind: "cell",
                    optional: src.optional ?? false,
            ...
            if (src.type === "slice") {
                if (src.format === "remainder") {
                    ...
                    (0, errors_1.throwInternalCompilerError)(`Unsupported slice format: ${src.format}`);
                }
                return {
                    kind: "slice",
                    optional: src.optional ?? false,
            ...
            if (src.type === "fixed-bytes") {
                if (src.format === 32 || src.format === 64) {
                    ...
                    (0, errors_1.throwInternalCompilerError)(`Unsupported fixed-bytes format: ${src.format}`);
                }
            }
            if (src.type === "string") {
                if (src.format !== null && src.format !== undefined) {
                    (0, errors_1.throwInternalCompilerError)(`Unsupported string format: ${src.format}`);
                }
                return {
                    kind: "string",
                    optional: src.optional ?? false,
            ...
            if (src.format === "ref") {
                ...
                (0, errors_1.throwInternalCompilerError)(`Unsupported struct format: ${src.format}`);
            }
            else {
                return {
                    kind: "struct",
        ...
        case "dict": {
            if (src.format !== null && src.format !== undefined) {
                (0, errors_1.throwInternalCompilerError)(`Unsupported map format: ${src.format}`);
            }
            return { kind: "map" };
        }
    }
...
function allocateSegment(ops, bits, refs) {
    ...
    const [totalBits, totalRefs] = ops.reduce(([sumBits, sumRefs], op) => {
