...
class FuncCompiler {
    constructor(funcWASMObject) {
        this.getDebuggerBinary = () => {
            ...
            const patch = (0, utils_1.base64Decode)(this.debuggerGzipPatchBase64);
            const unzipped = (0, fflate_1.gunzipSync)(patch);
            this.debuggerBinary = (0, utils_1.decodePatch)(this.wasmBinary, unzipped);
            return this.debuggerBinary;
        };
        this.createModule = async () => await this.module({ wasmBinary: this.wasmBinary });
        this.createDebuggerModule = async () => {
